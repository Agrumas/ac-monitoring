...
const API_ENTRY_POINT = 'http://localhost:8080/anticheat/api/';
const WS_ENTRY_POINT = 'ws://localhost:8080/anticheat/';
let babelPlugins = [];
...
module.exports = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      WEBPACK_WS_ENTRY_POINT: JSON.stringify(WS_ENTRY_POINT),
    }),
